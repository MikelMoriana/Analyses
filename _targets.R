...
list(
  ...
  tar_target(
    name = turfplot_Gud_1_2,
    command = turfplot(community_carex, "Gud_1_2_car") # Seems it is Car_vag in 2018. In the other cases either the other species were already present in the subplot, or none appear any year, and then better to drop them
  ),
  tar_target(
    name = turfplot_Gud_1_3,
    command = turfplot(community_carex, "Gud_1_3_car") # Seems it is Car_vag in all cases. No duplicates
  ),
  tar_target(
    name = turfplot_Gud_1_4,
    command = turfplot(community_carex, "Gud_1_4_car") # Seems it is Car_vag in all cases. Duplicates with unique()
  ),
  tar_target(
    name = turfplot_Gud_1_5,
    command = turfplot(community_carex, "Gud_1_5_car") # Seems it is Car_vag in all cases. Duplicate with unique()
  ),
  tar_target(
    name = turfplot_Gud_2_1,
    command = turfplot(community_carex, "Gud_2_1_car") # Seems it is Car_big in all cases. Subplot1 must be removed
  ),
  tar_target(
    name = turfplot_Gud_2_2,
    command = turfplot(community_carex, "Gud_2_2_car") # Seems it is Car_big in all cases. Subplot17 is cf, must be removed
  ),
  tar_target(
    name = turfplot_Gud_2_3,
    command = turfplot(community_carex, "Gud_2_3_car") # Seems it is Car_big in all cases. Duplicates with unique()
  ),
  tar_target(
    name = turfplot_Gud_2_4,
    command = turfplot(community_carex, "Gud_2_4_car") # Seems it is Car_big in all cases. Duplicate with unique()
  ),
  tar_target(
    name = turfplot_Gud_3_2,
    command = turfplot(community_carex, "Gud_3_2_car") # Seems it is Car_big in 2018 and Car_vag in 2019. Duplicate with unique()
  ),
  tar_target(
    name = turfplot_Gud_3_3,
    command = turfplot(community_carex, "Gud_3_3_car") # Seems it is Car_big in all cases. No duplicates
  ),
  tar_target(
    name = turfplot_Gud_3_5,
    command = turfplot(community_carex, "Gud_3_5_car") # Seems it is Car_vag in all cases. No duplicates
  ),
  tar_target(
    name = turfplot_Gud_4_1,
    command = turfplot(community_carex, "Gud_4_1_car") # All other Carex already present in that subplot. I drop it
  ),
  tar_target(
    name = turfplot_Gud_4_3,
    command = turfplot(community_carex, "Gud_4_3_car") # All other Carex already present in those subplots. I drop them
  ),
  tar_target(
    name = turfplot_Gud_4_4,
    command = turfplot(community_carex, "Gud_4_4_car") # All other Carex already present in those subplots. I drop them
  ),
  tar_target(
    name = turfplot_Gud_5_1,
    command = turfplot(community_carex, "Gud_5_1_car") # Seems it is Car_cap (looking at the scan). No duplicates
  ),
  tar_target(
    name = turfplot_Gud_5_2,
    command = turfplot(community_carex, "Gud_5_2_car") # All other Carex already present in that subplot. I drop it
  ),
  tar_target(
    name = turfplot_Gud_5_4,
    command = turfplot(community_carex, "Gud_5_4_car") # Seems it is Car_big. No duplicate
  ),
  tar_target(
    name = turfplot_Gud_5_5,
    command = turfplot(community_carex, "Gud_5_5_car") # Seems it is Car_vag in all cases. No duplicates
  ),
  tar_target(
    name = turfplot_Gud_7_2,
    command = turfplot(community_carex, "Gud_7_2_car") # Car_big: 3, 12 (2018), 14, 16. Car_vag: 12 (2021), 21. Both: 8. Remove: 15, 35
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Gud_7_3,
    command = turfplot(community_carex, "Gud_7_3_car") # One Car_big (subplot 30). All other Carex in the other subplot
  ),
  tar_target(
    name = turfplot_Gud_7_4,
    command = turfplot(community_carex, "Gud_7_4_car") # Seems it is Car_big in all cases. Duplicate with unique()
  ),
  tar_target(
    name = turfplot_Gud_7_6,
    command = turfplot(community_carex, "Gud_7_6_car") # Car_vag: 1, 24, 31. Car_big: 5. Car_fla: 8. Remove: 2
  ),
  tar_target(
    name = turfplot_Lav_2_2,
    command = turfplot(community_carex, "Lav_2_2_car") # Seems it is Car_pil. No duplicates
  ),
  tar_target(
    name = turfplot_Lav_4_3,
    command = turfplot(community_carex, "Lav_4_3_car") # Seems it is Car_vag. Duplicate with unique()
  ),
  tar_target(
    name = turfplot_Skj_5_3,
    command = turfplot(community_carex, "Skj_5_3_car") # Seems it is Car_cap. No duplicates
  ),
  tar_target(
    name = turfplot_Ulv_3_3,
    command = turfplot(community_carex, "Ulv_3_3_car") # It is probably Car_pal. No duplicates
  ),
  tar_target(
    name = turfplot_Ulv_3_5,
    command = turfplot(community_carex, "Ulv_3_5_car") # It is probably Car_big. No duplicates
  ),
  tar_target(
    name = turfplot_Ulv_6_3,
    command = turfplot(community_carex, "Ulv_6_3_car") # Not enough information to decide. I drop it
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Gud_7_3,
    command = turfplot(community, "Gud_7_3") # Seems it is Gen_niv
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Gud_4_3,
    command = turfplot(community, "Gud_4_3") # Difficult to tell
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Gud_7_3,
    command = turfplot(community, "Gud_7_3") # Difficult to tell
  ),
  tar_target(
    name = turfplot_Gud_7_6,
  ...
  tar_target(
    name = turfplot_Skj_2_5,
    command = turfplot(community, "Skj_2_5") # Difficult to tell
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Ulv_1_4,
    command = turfplot(community, "Ulv_1_4") # Difficult to tell
  ),
  tar_target(
    name = turfplot_Ulv_6_3,
  ...
  tar_target(
    name = turfplot_Skj_1_4,
    command = turfplot(community, "Skj_1_4") # Difficult to tell
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Lav_3_3,
    command = turfplot(community, "Lav_3_3") # Sal_sp does not exist in the scan. The values are not from another species
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Lav_3_3,
    command = turfplot(community, "Lav_3_3") # The scans says Suc_vul, it is Suc_pra
  ),
  tar_target(
  ...
  tar_target(
    name = turfplot_Lav_2_2,
    command = turfplot(community, "Lav_2_2") # There are a few mistakes in 2021: Ant_alp is actually Alc_alp, the values of Tar_sp belong to Bis_viv (we need to write the correct ones), Ver_alp is missing in subplot 1
  ),
  tar_target(
